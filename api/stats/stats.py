"""
Stats API Endpoints | Cannlytics API
...
Description: API endpoints to interface with cannabis statistics.
"""
# External imports
...
@api_view(['GET', 'POST'])
def stats_base(request, state=None):
    """Get or update information about statistics."""
