...
export const helpSettings = {
  ...
  async inviteUser() {
    ...
    const data = {
      name,
      subject: 'Invitation to the Cannabis Data',
      message: message,
      email: user.email || 'No user',
      organization: user.organization || 'No organization',
      from: 'hello@cannabisdata.com',
      reply: 'hello@cannabisdata.com',
      recipients: ['hello@cannabisdata.com'],
      promo: code,
    };
  ...
  async sendFeedback() {
    ...
    const data = {
      ...
      subject: 'New Cannabis Data feedback!',
      message: message,
      email: user.email || 'No user',
      organization: user.organization || 'No organization',
      from: 'hello@cannabisdata.com',
