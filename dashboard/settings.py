...
# ROOT_URLCONF = 'urls'
SECRET_SETTINGS_NAME = 'cannabisdata_settings' # Define your secret's name.
...
try:
    ...
    EMAIL_PORT = 587
    DEFAULT_FROM_EMAIL = 'hello@cannabisdata.com'
    LIST_OF_EMAIL_RECIPIENTS = [DEFAULT_FROM_EMAIL]
